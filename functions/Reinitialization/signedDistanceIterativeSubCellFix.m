function data = signedDistanceIterativeSubCellFix(grid, data0, accuracy, tMax, errorMax)
...
% ////////////////////////////////////////////////////////
% Same as signedDistanceIterative but with subcell fix enabled!
...
if(iscell(data0))
  ...
  for i = 1 : length(data0)
    if(iscell(grid))
      data{i} = signedDistanceIterativeSubCellFix(grid{i}, data0{i}, accuracy, ...
                                        tMax, errorMax);
    else
      data{i} = signedDistanceIterativeSubCellFix(grid, data0{i}, accuracy, ...
                                        tMax, errorMax);
    end
  end
end

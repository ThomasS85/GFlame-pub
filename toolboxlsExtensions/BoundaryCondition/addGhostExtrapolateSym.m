function dataOut = addGhostExtrapolateSym(dataIn, dim, width, ghostData)
% addGhostExtrapolate: add ghost cells, with values extrapolated from bdry nodes and a symmetry 
%   BC on the other side. Bottom BC is symmetry!
%
...
% // Created, 20.04.2016 as part of GFLAME 0.1          //
% ////////////////////////////////////////////////////////

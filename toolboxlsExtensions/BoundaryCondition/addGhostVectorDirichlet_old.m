...
%
% ////////////////////////////////////////////////////////
% // Thomas Steinbacher (tsteinbacher@td.mw.tum.de).    //
% // Created, 01.12.2014 as part of GFLAME 0.1          //
% // Last modified: 01.12.2014 by tsteinbacher          //
% ////////////////////////////////////////////////////////
...
if insertDim == 1
  ...
  lowerBoundary_values = repmat( lowerVector , 1 , fill_width );
  upperBoundary_values = repmat( upperVector , 1 , fill_width );
  ...
  lowerBoundary_values = repmat( lowerVector , fill_width , 1 );
  upperBoundary_values = repmat( upperVector , fill_width , 1 );
  
end


% (a) lower
indicesOut{dim} = 1 : fill_width;
...
% (b) upper
indicesOut{dim} = sizeOut(dim) - fill_width + 1 : sizeOut(dim);
% cells to add along boundary (neccessary when curvature is activated)
n_domain = length(indicesOut{insertDim});                 % beta!
